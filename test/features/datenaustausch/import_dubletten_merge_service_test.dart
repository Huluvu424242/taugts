...
void main() {
  ...
  test(
      'Produktmerge übernimmt gewählte Stammdaten und hängt gesamte Historie um',
      () {
      ...
      'preisbeobachtungen': [
        {
          'id': 'preis-1',
          'erlebnisId': 'e-1',
          'erlebnisPositionId': 'pos-1',
          'produktId': 'import-p',
          'ortId': 'o-1',
          'betragMinor': 450,
          'beobachtetAm': '2026-09-01T18:00:00Z'
        },
        {
          'id': 'preis-2',
          'erlebnisId': 'e-2',
          'erlebnisPositionId': 'pos-2',
          'produktId': 'anderes-p',
          'ortId': 'o-1',
          'betragMinor': 399,
          'beobachtetAm': '2026-08-01T18:00:00Z'
        },
      ],
      'bewertungen': [
        {
          ...
          'erlebnisPositionId': 'pos-1',
          'ortId': 'o-1',
          'bewertetAm': '2026-09-01T18:30:00Z',
          'wert': '4'
        },
      ],
    ...
    expect(
        ((ergebnis.dokument['erlebnisPositionen'] as List).single
            as Map)['produktId'],
        'lokal-p');
    expect(
        ((ergebnis.dokument['preisbeobachtungen'] as List).first
            as Map)['produktId'],
        'lokal-p');
    expect(
        ((ergebnis.dokument['bewertungen'] as List).single as Map)['objektId'],
        'lokal-p');
    expect(
        ((ergebnis.dokument['kategorieZuordnungen'] as List).single
            as Map)['zielId'],
        'lokal-p');
    expect(
        ((ergebnis.dokument['preisbeobachtungen'] as List)[1]
            as Map)['produktId'],
        'anderes-p');
  ...
  test(
      'Ortsmerge erhält Bewertungen, Preise und Zeitkontext und hängt nur Ortsreferenzen um',
      () {
    final lokal = <String, Object?>{
      'orte': [
        {
      ...
      'erlebnisse': [
        {
          'id': 'e-1',
          'ortId': 'import-o',
          'tatsaechlicherBeginn': '2026-08-10T18:00:00Z'
        },
      ],
      'preisbeobachtungen': [
        {
          ...
          'produktId': 'prod-1',
          'ortId': 'import-o',
          'beobachtetAm': '2026-08-10T18:05:00Z',
          'betragMinor': 420
        },
      ],
      'bewertungen': [
        {
          ...
          'erlebnisId': 'e-1',
          'ortId': 'import-o',
          'bewertetAm': '2026-08-10T18:30:00Z',
          'wert': '3.5'
        },
        {
          'id': 'b-ort',
          ...
          'erlebnisId': 'e-1',
          'ortId': 'import-o',
          'ortsbewertungId': 'ob-1',
          'bewertetAm': '2026-08-10T19:00:00Z',
          'wert': '4'
        },
      ],
      'ortsbewertungen': [
    ...
    expect(((ergebnis.dokument['erlebnisse'] as List).single as Map)['ortId'],
        'lokal-o');
    expect(
        ((ergebnis.dokument['preisbeobachtungen'] as List).single
            as Map)['ortId'],
        'lokal-o');
    ...
    expect(
        ((ergebnis.dokument['ortsbewertungen'] as List).single as Map)['ortId'],
        'lokal-o');
    expect(
        ((ergebnis.dokument['preisbeobachtungen'] as List).single
            as Map)['beobachtetAm'],
  ...
  test(
      'Aliasreferenzen erkennen spätere Import-IDs auch über Alias-Ketten wieder',
      () {
  ...
  test('Eingabedokument wird bei der Merge-Planung nicht verändert', () {
    ...
    expect(
        ((import['bewertungen'] as List).single as Map)['objektId'], 'import');
  });
}
